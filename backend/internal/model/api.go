...
// SearchQueryCandidate is an alternative query generated by the LLM with a specific search intent.
type SearchQueryCandidate struct {
	Query  string `json:"query"`
	Intent string `json:"intent"` // "product_page" | "model_lookup" | "price_comparison"
}
...
type RecognizedObject struct {
	...
	SearchQueries    []SearchQueryCandidate `json:"searchQueries,omitempty"`
